...
export interface ApiBannerBanner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    imagemDesktop: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    ...
    posicao: Schema.Attribute.Enumeration<
      ['hero', 'promotional', 'secondary']
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    ...
    textoDestaque: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Products for the pet store';
    displayName: 'Product';
    pluralName: 'products';
  ...
  attributes: {
    categorias: Schema.Attribute.Relation<
      ...
      'api::category.category'
    >;
    cores: Schema.Attribute.Component<'product.color', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    descricaoLonga: Schema.Attribute.RichText & Schema.Attribute.Required;
    emPromocao: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    > &
      Schema.Attribute.Private;
    novoLancamento: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    ...
    tamanhos: Schema.Attribute.Component<'product.size', true>;
    titulo: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 200;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vendidos: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    vitrines: Schema.Attribute.Relation<'manyToMany', 'api::showcase.showcase'>;
  };
}
...
export interface ApiShowcaseShowcase extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Product showcases/vitrines for homepage';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    criterioAutomatico: Schema.Attribute.JSON;
    identificador: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 100;
    ...
    produtos: Schema.Attribute.Relation<'manyToMany', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    tipo: Schema.Attribute.Enumeration<['manual', 'automatic']> &
      Schema.Attribute.Required;
    titulo: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
